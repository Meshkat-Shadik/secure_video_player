...
#ifndef SECURE_VIDEO_PLAYER_SWIFT_H
#define SECURE_VIDEO_PLAYER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="secure_video_player",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC19secure_video_player23SecureVideoPlayerPlugin")
@interface SecureVideoPlayerPlugin : NSObject <FlutterPlugin>
